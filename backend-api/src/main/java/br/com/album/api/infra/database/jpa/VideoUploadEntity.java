...
public class VideoUploadEntity {
    ...
    @Column(name = "preview_object_key", length = 255)
    private String previewObjectKey;

    @Column(name = "rendition_360_object_key", length = 255)
    private String rendition360ObjectKey;

    @Column(name = "rendition_720_object_key", length = 255)
    private String rendition720ObjectKey;

    @Column(name = "dash_manifest_object_key", length = 255)
